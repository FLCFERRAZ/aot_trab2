...
* First Number (A):
  ...
  1. Bit 1: Arduino Pin 1
  1. Bit 2: Arduino Pin 2
  1. Bit 3 (MSB): Arduino Pin 3
* Second Number (B):
  1. Bit 0 (LSB): Arduino Pin 4
  1. Bit 1: Arduino Pin 5
  1. Bit 2: Arduino Pin 6
  1. Bit 3 (MSB): Arduino Pin 7
## Output Pins (Result):
* Sum Output:
  1. Bit 0 (LSB): Arduino Pin 8
  1. Bit 1: Arduino Pin 9
  1. Bit 2: Arduino Pin 10
  1. Bit 3 (MSB): Arduino Pin 11
